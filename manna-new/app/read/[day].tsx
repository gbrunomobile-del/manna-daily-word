...
import { getDayReading, passagesForDay } from '@/data/plan/year-plan';
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        if (!cancelled) setError('Could not load today\'s reading. Check your connection.');
      } finally {
        ...
        <View style={styles.centre}>
          <Animated.View entering={FadeInDown.duration(700)} style={{ alignItems: 'center', gap: 22 }}>
            ...
            <Text variant="body" tone="muted" style={{ textAlign: 'center', paddingHorizontal: 40, lineHeight: 22 }}>
              Day {day} is complete. These chapters are now part of your journey — you will see them lit wherever they appear again.
            </Text>
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          {passages.map((p, i) => (
            ...
            >
              ...
              <Text
                variant="reference"
                style={{ color: t.colors.accent, marginTop: 4, marginBottom: 12 }}
              >
                {p.reference}
              </Text>
