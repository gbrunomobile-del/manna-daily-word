...
export const QUESTIONS: Record<string, Question[]> = {
  ...
  'miracles-2': [
    {
      kind: 'mcq',
      prompt: 'What did the four friends do to reach Jesus?',
      options: ['Waited', 'Dug through the roof', 'Called out', 'Left'],
      answer: 1,
      teachingKeyword: 'THEIR FAITH.',
      insight: 'Mark says Jesus saw their faith — the friends’, not the paralysed man’s. Somebody else’s belief carried him.',
      verse: 'Mark 2:5',
    },
    {
      kind: 'tf',
      prompt: 'Jesus healed a man who had been ill for thirty-eight years.',
      answer: true,
      insight: 'And asked him first whether he wanted to be well — a strange question, and not a rhetorical one.',
      verse: 'John 5:6',
    },
    {
      kind: 'mcq',
      prompt: 'How many of the ten healed of leprosy came back?',
      options: ['All ten', 'One', 'Three', 'None'],
      answer: 1,
      insight: 'And Luke notes he was a Samaritan. The one who returns is the one who least belonged.',
      verse: 'Luke 17:16',
    },
    {
      kind: 'tf',
      prompt: 'Jesus could do no mighty work in his home town.',
      answer: true,
      insight: 'Mark says so plainly, and gives the reason: their unbelief. He marvelled at it.',
      verse: 'Mark 6:5',
    },
    {
      kind: 'whosaid',
      quote: 'I believe. Help my unbelief!',
      options: ['Peter', 'A father', 'Thomas', 'Jairus'],
      answer: 1,
      insight: 'A father asking for his son. One of the most honest sentences anyone says in the Gospels.',
      verse: 'Mark 9:24',
    },
    {
      kind: 'cloze',
      prompt: 'Complete what Jesus said before feeding the crowd.',
      text: 'You give them something to ___.',
      options: ['eat', 'do', 'hope', 'carry'],
      answer: 0,
      insight: 'Said to disciples who had just suggested sending everyone away. The impossible task is handed back to them.',
      verse: 'Mark 6:37',
    },
  ],
  ...
  'cross-2': [
    {
      kind: 'mcq',
      prompt: 'What did Jesus pray in Gethsemane?',
      options: ['For strength', 'That the cup be taken, yet not his will', 'For his disciples', 'Nothing'],
      answer: 1,
      teachingKeyword: 'YET NOT MY WILL.',
      insight: 'He asks and then submits, in the same sentence. Luke records that he sweated as though bleeding.',
      verse: 'Luke 22:42',
    },
    {
      kind: 'tf',
      prompt: 'Peter denied knowing Jesus three times.',
      answer: true,
      insight: 'Having sworn hours earlier that he would die first. Luke adds that Jesus turned and looked at him.',
      verse: 'Luke 22:61',
    },
    {
      kind: 'mcq',
      prompt: 'What did Jesus say to the criminal beside him?',
      options: ['Nothing', 'Today you will be with me in Paradise', 'Repent', 'Believe'],
      answer: 1,
      insight: 'A man with hours to live and no opportunity to make anything of it. He is promised it anyway.',
      verse: 'Luke 23:43',
    },
    {
      kind: 'tf',
      prompt: 'A Roman centurion said something about Jesus at the end.',
      answer: true,
      insight: 'Truly this was the Son of God — the first confession after the death comes from the execution detail.',
      verse: 'Mark 15:39',
    },
    {
      kind: 'mcq',
      prompt: 'How was Peter restored afterwards?',
      options: ['Publicly rebuked', 'Asked three times whether he loved him', 'Sent away', 'Never mentioned'],
      answer: 1,
      insight: 'Three questions for three denials, over breakfast on a beach. Nothing else is said about it.',
      verse: 'John 21:17',
    },
    {
      kind: 'cloze',
      prompt: 'Complete what Jesus said from the cross.',
      text: 'Father, into your hands I commit my ___.',
      options: ['spirit', 'life', 'body', 'work'],
      answer: 0,
      insight: 'A line from Psalm 31 — a bedtime prayer Jewish children were taught. He dies saying his prayers.',
      verse: 'Luke 23:46',
    },
  ],
  ...
  'acts-unit-2': [
    {
      kind: 'mcq',
      prompt: 'What did the early believers do with their possessions?',
      options: ['Kept them', 'Sold and shared as anyone had need', 'Gave them to the temple', 'Buried them'],
      answer: 1,
      teachingKeyword: 'AS ANY HAD NEED.',
      insight: 'Not a rule but a practice, and Acts records it failing later as well as working here.',
      verse: 'Acts 2:45',
    },
    {
      kind: 'tf',
      prompt: 'Peter and John were arrested for preaching.',
      answer: true,
      insight: 'And told to stop. Their answer was that they could not help speaking of what they had seen.',
      verse: 'Acts 4:20',
    },
    {
      kind: 'mcq',
      prompt: 'What convinced Peter to enter a Gentile\u2019s house?',
      options: ['A letter', 'A vision of a sheet of animals', 'An order', 'A dream of Jesus'],
      answer: 1,
      insight: 'Told three times not to call unclean what God had cleansed. He is still puzzling over it when the knock comes.',
      verse: 'Acts 10:15',
    },
    {
      kind: 'tf',
      prompt: 'Believers were first called Christians in Antioch.',
      answer: true,
      insight: 'A nickname given by outsiders, in a mixed Greek city rather than in Jerusalem.',
      verse: 'Acts 11:26',
    },
    {
      kind: 'mcq',
      prompt: 'What happened while Paul and Silas sang in prison?',
      options: ['They were released', 'An earthquake opened the doors', 'The guards fled', 'Nothing'],
      answer: 1,
      insight: 'And they stayed. The jailer’s question comes because nobody ran.',
      verse: 'Acts 16:26',
    },
    {
      kind: 'whosaid',
      quote: 'Silver and gold have I none, but what I have, I give you.',
      options: ['Peter', 'John', 'Paul', 'Stephen'],
      answer: 0,
      insight: 'To a beggar at the temple gate who had asked for money and got something else.',
      verse: 'Acts 3:6',
    },
  ],
  ...
  'letters-2': [
    {
      kind: 'mcq',
      prompt: 'What does Paul say about his thorn in the flesh?',
      options: ['It was removed', 'He asked three times and was refused', 'He never mentions it', 'It was healed slowly'],
      answer: 1,
      teachingKeyword: 'SUFFICIENT.',
      insight: 'My grace is sufficient for you. An answer, but not the one he asked for.',
      verse: '2 Corinthians 12:9',
    },
    {
      kind: 'tf',
      prompt: 'Paul confronted Peter publicly.',
      answer: true,
      insight: 'To his face, for withdrawing from Gentiles when certain visitors arrived. Recorded in a letter Peter’s friends would read.',
      verse: 'Galatians 2:11',
    },
    {
      kind: 'mcq',
      prompt: 'What does Paul call the greatest of faith, hope and love?',
      options: ['Faith', 'Hope', 'Love', 'They are equal'],
      answer: 2,
      insight: 'Written to a congregation ranking spiritual gifts against one another.',
      verse: '1 Corinthians 13:13',
    },
    {
      kind: 'tf',
      prompt: 'Paul worked to support himself while preaching.',
      answer: true,
      insight: 'As a tentmaker, night and day, so as not to burden anyone. He mentions it more than once.',
      verse: '1 Thessalonians 2:9',
    },
    {
      kind: 'cloze',
      prompt: 'Complete the verse.',
      text: 'I have learned in whatever state I am, to be ___.',
      options: ['content', 'grateful', 'patient', 'still'],
      answer: 0,
      insight: 'Learned, not felt — described as a skill acquired by someone who had been hungry often enough to mean it.',
      verse: 'Philippians 4:11',
    },
    {
      kind: 'whosaid',
      quote: 'I have fought the good fight. I have finished the course.',
      options: ['Peter', 'Paul', 'James', 'John'],
      answer: 1,
      insight: 'From what is probably his last letter, written expecting execution.',
      verse: '2 Timothy 4:7',
    },
  ],
  ...
  'revelation-unit-2': [
    {
      ...
      options: ['Jerusalem', 'Rome', 'The island of Patmos', 'Ephesus'],
      answer: 2,
      insight: 'Exiled on a small island for the word of God. The most expansive vision in Scripture given to a man with nowhere to go.',
      verse: 'Revelation 1:9',
    },
    {
      kind: 'tf',
      prompt: 'The letters to the seven churches are mostly praise.',
      answer: false,
      teachingKeyword: 'I KNOW.',
      insight: 'Each begins with “I know your works”, and most contain a correction. Only two escape rebuke entirely.',
      verse: 'Revelation 2:2',
    },
    {
      kind: 'mcq',
      prompt: 'What had the church at Ephesus lost?',
      options: ['Its members', 'Its first love', 'Its teaching', 'Its wealth'],
      answer: 1,
      insight: 'They are commended for endurance, discernment and hard work first — and then told what is missing.',
      verse: 'Revelation 2:4',
    },
    {
      kind: 'tf',
      prompt: 'The vision includes a crowd no one could count.',
      answer: true,
      insight: 'From every nation, tribe, people and language. The reach promised to Abraham, shown as arrived.',
      verse: 'Revelation 7:9',
    },
    {
      kind: 'cloze',
      prompt: 'Complete the closing invitation.',
      text: 'Let him who is thirsty come. Whoever desires, let him take the water of life ___.',
      options: ['freely', 'gladly', 'quickly', 'humbly'],
      answer: 0,
      insight: 'The last invitation in the Bible, and it costs nothing — the same offer Isaiah made to people with no money.',
      verse: 'Revelation 22:17',
    },
    {
      kind: 'mcq',
      prompt: 'What is said about the tree of life at the end?',
      options: ['It is gone', 'Its leaves are for the healing of the nations', 'It is guarded', 'It is hidden'],
      answer: 1,
      insight: 'The tree fenced off in Genesis 3 is standing open in the last chapter, on both sides of the river.',
...
export const UNITS: Record<string, string[]> = {
  ...
  noah: ['noah', 'noah-2'],
  abraham: ['abraham', 'abraham-2'],
  joseph: ['joseph', 'joseph-2'],
  moses: ['moses', 'moses-2'],
  'the-law': ['the-law', 'the-law-2'],
  david: ['david', 'david-2'],
  isaiah: ['isaiah', 'isaiah-2'],
  birth: ['birth', 'birth-2'],
  ministry: ['ministry', 'ministry-2'],
  miracles: ['miracles', 'miracles-2'],
  cross: ['cross', 'cross-2'],
  // Named to avoid reading like chapter references, which is what the
  // similarly-shaped keys in the chapter bank mean.
  acts: ['acts', 'acts-unit-2'],
  letters: ['letters', 'letters-2'],
  revelation: ['revelation', 'revelation-unit-2'],
};
